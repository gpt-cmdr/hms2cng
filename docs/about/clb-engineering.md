...
Within two years, CLB Engineering built the **most robust and feature-complete HEC-HMS and HEC-RAS automation solution on the open internet** using LLM Forward approaches:

- **[hms2cng](https://github.com/gpt-cmdr/hms2cng)**: CLI tool for exporting HEC-HMS results to GeoParquet, PMTiles, and PostGIS
- **[hms-commander](https://github.com/gpt-cmdr/hms-commander)**: Comprehensive library for HEC-HMS automation
- **[ras-commander](https://github.com/gpt-cmdr/ras-commander)**: 50+ modules covering HEC-RAS automation
- **50+ example notebooks**: Production-quality demonstrations
...
| **Multi-Level Verifiability** | GUI review + visual outputs (plots/figures) + code audit trails |
...
If you use hms2cng in your work, please cite the library:

> This analysis used hms2cng ([https://github.com/gpt-cmdr/hms2cng](https://github.com/gpt-cmdr/hms2cng)), an open-source CLI tool for HEC-HMS cloud-native export by CLB Engineering Corporation.
